...
<section class="container my-5">
    ...
    <div onclick="location.href='/video/If-You-Have-a-Dream-Reprise/';" class="card clickable">
        <img src="/thumbnails/If-You-Have-a-Dream-Reprise.jpg" class="card-img-top" style="height: 360; width: 640;" alt="Thumbnail">
        <div class="card-body">
...
<div class="col-lg-4 cell">
    <div onclick="location.href='/video/My-2024-Medley/';" class="card clickable">
        <img src="/thumbnails/My-2024-Medley.jpg" class="card-img-top" style="height: 360; width: 640;" alt="Thumbnail">
        <div class="card-body">
...
<div class="col-lg-4 cell">
    <div onclick="location.href='/video/My-2023-Medley/';" class="card clickable">
        <img src="/thumbnails/My-2023-Medley.jpg" class="card-img-top" style="height: 360; width: 640;" alt="Thumbnail">
        <div class="card-body">
            <h6 class="search-show text-muted fw-light">Original Remix</h6>
