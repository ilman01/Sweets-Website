    ...
    <div class="row g-4 d-flex align-items-center justify-content-center">
        <div class="col-lg-4">
            <div onclick="location.href='/video/My-2024-Medley.html';" class="card clickable">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a class="text-decoration-none text-black">My 2024 Medley</a></h5>
        ...
        <div class="col-lg-4">
            <div onclick="location.href='My-2023-Medley.html';" class="card clickable">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a class="text-decoration-none text-black">My 2023 Medley</a></h5>
