    ...
    <div class="row g-4">
        <div class="col-lg-4 cell">
            <div onclick="location.href='/video/If-You-Have-a-Dream-Reprise';" class="card clickable">
                ...
                <div class="card-body">
                    <h6 class="search-title text-muted fw-light">Fancy Nancy</h6>
        ...
        <div class="col-lg-4 cell">
            <div onclick="location.href='/video/My-2024-Medley';" class="card clickable">
                ...
                <div class="card-body">
                    <h6 class="search-title text-muted fw-light">Original Remix</h6>
        ...
        <div class="col-lg-4 cell">
            <div onclick="location.href='/video/Grow-With-Me';" class="card clickable">
                ...
                <div class="card-body">
                    <h6 class="search-title text-muted fw-light">Alice's Wonderland Bakery</h6>
